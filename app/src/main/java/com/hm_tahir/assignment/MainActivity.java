package com.hm_tahir.assignment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private FirebaseFirestore objectFF;
    private CollectionReference objectCR;
    private DocumentReference objectDR;

    private static String storesDetails="StoresDetails";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            objectFF=FirebaseFirestore.getInstance();
            objectCR=objectFF.collection(storesDetails);
    ...
    public  void deleteDoc(View view){
        try{
            if(!docId.getText().toString().isEmpty()){
                objectDR=objectFF.collection(storesDetails).document(docId.getText().toString());
                        ...
                        .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                            ...
                            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                for(DocumentSnapshot objDocumentSnapshot:queryDocumentSnapshots){
                                    ...
                                    objectDR=objectFF.collection(storesDetails).document(id);
                                    objectDR.delete();
                                }
                        ...
                        .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                            ...
                            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                ...
                                if(check==1){
                                    ...
                                    objectFF.collection(storesDetails)
